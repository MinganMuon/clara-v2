...
enum TileType {
	TILE_BLACK, TILE_BLACK_KING, TILE_RED, TILE_RED_KING, TILE_EMPTY, TILE_INVALID
};

typedef std::array<TileType,46> BoardType;

const BoardType WhiteAboveBlackBoard = {TILE_INVALID, TILE_INVALID, TILE_INVALID, TILE_INVALID, TILE_INVALID, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_INVALID, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_INVALID, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_INVALID, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_INVALID, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_INVALID, TILE_INVALID, TILE_INVALID, TILE_INVALID, TILE_INVALID};
const BoardType BlackAboveWhiteBoard = {TILE_INVALID, TILE_INVALID, TILE_INVALID, TILE_INVALID, TILE_INVALID, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_INVALID, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_BLACK, TILE_INVALID, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_INVALID, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_INVALID, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_WHITE, TILE_INVALID, TILE_INVALID, TILE_INVALID, TILE_INVALID, TILE_INVALID};
